...
/**
 * Created by daniel.tomes on 3/23/17.
 */
public class ISHProcessor implements Serializable {
...
//  Fields making up the MW1-7 elements
    ...
    public String processISHLine(String line)
    {
...
//                    return sOutputRecord;                // Return the record
